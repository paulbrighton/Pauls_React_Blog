        ...
        <section className='c-about'>
          ...
          <div className='o-about-intro__container'>
            <div className='c-about__text'>
              <p>I’m Paul and I am currently a student of the full stack web development course at &#123;Pro&#125;Coders in Leeds.</p>
              ...
              <p>I decided not to do my second year at university due to the lecturer leaving the course and a suitable lecturer not been available for the second year. This led me into looking for other web development courses and I found that the &#123;Pro&#125;Coders course covered the skills I would need to pursue a career as a full-stack developer.</p>
            </div>
          </div>
        </section>
        ...
        <section className='c-about-cv'>
          ...
          <div className='c-about-cv__category c-about-cv__category-lists'>
            ...
            <ul>
              ...
              <li>Computer literate (Mac and PC);</li>
